...
export const TAB_ICONS: Record<TabType, string> = {
  ...
  'prompt-library': 'i-ph:book-open-text',
...
export const TAB_DESCRIPTIONS: Record<TabType, string> = {
  ...
  'prompt-library': 'Manage and customize AI prompts and rules',
...
export const DEFAULT_TAB_CONFIG = [
  ...
  { id: 'prompt-library', visible: true, window: 'user' as const, order: 7 },
  ...
  { id: 'prompt-library', visible: true, window: 'developer' as const, order: 7 },
