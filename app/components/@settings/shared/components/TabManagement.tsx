...
import type { TabType, WindowType, UserTabConfig, TabVisibilityConfig } from '~/components/@settings/core/types';
...
const OPTIONAL_USER_TABS: TabType[] = ['profile', 'settings', 'task-manager', 'service-status', 'debug', 'update', 'prompt-library'];
